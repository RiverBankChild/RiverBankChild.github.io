...
Currently, I work as an Algorithm Engineer at **Kunlun Digital Technology (昆仑数智)**, focusing on the practical deployment of LLMs, RAG, and Agentic systems in complex enterprise environments.

**My Research Philosophy:**
I define myself as an **"Architectural Essentialist."** While I value rigorous mathematical proof, I believe that **structural intuition** precedes it. My research stems from observing patterns in engineering practice—identifying how mechanisms at the micro-scale (neurons) echo those at the macro-scale (agents).
...
#### 📄 *Attention as a Generalized Activation Mechanism: A Hierarchical View*
...
*   **D1 (Neuronal):** Existence Gating (e.g., ReLU) — *Scalar level*
*   **D2 (Contextual):** Relevance Weighting (Self-Attention) — *Vector level*
*   **D3 (Functional):** Expert Routing (MoE) — *Function level*
*   **D4 (Systemic):** Systemic Attention (Multi-Agent Supervisor) — *Agent level*
